...
<!-- "Welcome to my defense of my thesis with the title .. " -->
...
depiction.](table-methods-colored.png "Overview of methods for classifying open-ended survey responses.")
...
<figure> 
    ...
    <figcaption>Figure 1: Supervised Classification for a Trust Question.</figcaption>
</figure>
...
- 2.  fine-tuning the weights of two BERT[^2] models, using the manually coded data as training
            data, to classify the remaining n=\[[6,500]{style="color:orange"}/[6,000]{style="color:blue"}\]
:::
...
<figcaption>Figure 3: Methods for Sentiment and Emotion
...
<img src="paper3/results-emotion-short.png"/>

<figcaption>Figure 4: Emotion Recognition for Speech Data with
SpeechBrain.<br><em>Note.</em> n_neutral=408, n_anger=44,
n_sadness=18, n_happiness=21.</figcaption>

</figure>
:::

<!-- mention the formale nature of survey settings as a possible explanation and that speechbrain hasnt been used in social science research so far and we need more applications with other survey datasets -->
...
::: fragment
-   traditional semi-automated methods, e.g. supervised ML, require sufficient and high-quality
